...
INTENT_KEYWORDS: Dict[str, List[str]] = {
    ...
    INTENT_FGI_COMPARE: [
         ...
         "beda fgi env",
         "beda fgi-r",
         "perbedaan fgi env dan fgi-r",
         "apa beda fgi env dan fgi-r",
         "apa beda fgi env dan fgi r",
         "beda fgi env dan fgi r",
         "fgi env dan fgi-r bedanya apa",
         "fgi env dan fgi r bedanya apa",
         "apa perbedaan fgi env dengan fgi-r",
         "apa perbedaan fgi env dengan fgi r",
    ...
    INTENT_RELATIVE_OPPORTUNITY: [
    "area lebih menjanjikan",
    "hotspot",
    "potensi ikan di mana",
    "mana area",
    "lebih baik di mana",
    "relatif lebih menjanjikan",
    "mana lokasi yang lebih baik",
    "spot mana yang lebih menjanjikan",
    "potensi ikan",
    "potensi ikan hari ini",
    "kelimpahan ikan",
    "kelimpahan ikan di perairan",
    "ikan melimpah",
    "banyak ikan",
    "ikan banyak",
    "ikan lagi banyak",
    "lagi banyak ikan",
    "ikan lagi banyak atau tidak",
    "lagi banyak atau tidak",
    "ikan banyak atau tidak",
    "hari ini ikan banyak",
    "hari ini ikan banyak tidak",
    "ikan ada banyak atau tidak",
    "peluang ikan",
    "peluang awal penangkapan",
    "area ikan lebih banyak",
    "indikasi kelimpahan ikan",
    "perairan mana",
    "perairan mana yang ikannya relatif lebih banyak",
