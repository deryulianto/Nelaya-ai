...
def main() -> None:
    ...
    # Untuk Feature Store regional, p95 dibaca sebagai hotspot support.
    ...
    # Sama seperti dynamic physics, p95 lebih cocok sebagai dukungan hotspot temporal.
    ...
    # Temporal confidence adalah kualitas umum memori waktu, jadi mean lebih jujur.
    temporal_confidence = (
        temporal_confidence_mean
