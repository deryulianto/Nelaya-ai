...
def main() -> None:
    ...
    dynamic_physics_score = to_float(
        pick(
            dynamic,
            [
                "dynamic_physics_score",
                "metrics.dynamic_physics_score",
                "summary.dynamic_physics_score",
                "summary.mean_dynamic_physics_score",
            ],
        )
    )

    temporal_memory_score = to_float(
        pick(
            temporal,
            [
    ...
    # Untuk feature store regional, p95 lebih representatif sebagai
    # "hotspot support" dibanding mean seluruh wilayah.
    bathymetry_score = bathymetry_score_p95 or bathymetry_score_mean or bathymetry_score_max
